...
[`Dirac()`](https://elies-ramon.github.io/kerntools/reference/Dirac.md)
function to the
...
![Dirac kernel PCA.](reference/figures/README-example-1.png)
...
on your data. To see in detail how to customize a
[`kPCA()`](https://elies-ramon.github.io/kerntools/reference/kPCA.md)
plot, please refer to the documentation. The projection matrix is also
returned (`dirac_kpca$projection`), so you may use it for further
analyses and/or creating your own plot.
...
- Compositional data (relative frequencies or proportions):
  Compositional-Linear and Aitchison kernels.

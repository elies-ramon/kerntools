...
To see detailed and step-by-step examples that illustrate the main cases of use of `kerntools`, please have a look to the vignette:
...
The documentation of the example dataset is available in an analogous way, typing:
